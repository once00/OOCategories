//
//  OOUICollectionViewFlowLayout.m
//  TUIKitDemo
//
...
#import "OOUICollectionViewFlowLayout.h"
#import "OOCommonMacro.h"

@interface OOUICollectionViewFlowLayout(){
    //在居中对齐的时候需要知道这行所有cell的宽度总和
    CGFloat _sumCellWidth ;
}
@end

@implementation OOUICollectionViewFlowLayout
-(instancetype)init{
    return [self initWithType:OOUICollectionViewFlowLayoutWithCenter betweenOfCell:5.0];
}
...
-(instancetype)initWithType:(OOUICollectionViewFlowLayoutCellAlignType)cellType betweenOfCell:(CGFloat)betweenOfCell{
    ...
    if (self){
        ...
        self.minimumLineSpacing = CONTROL_W(8);
        self.minimumInteritemSpacing = betweenOfCell;
...
-(void)setCellFrameWith:(NSMutableArray*)layoutAttributes{
    ...
    switch (_cellType) {
        case OOUICollectionViewFlowLayoutWithLeft:
        ...
        case OOUICollectionViewFlowLayoutWithCenter:
        ...
        case OOUICollectionViewFlowLayoutWithRight:
